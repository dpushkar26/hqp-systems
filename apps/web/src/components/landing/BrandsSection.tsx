...
export function BrandsSection() {
  return (
    <div className="w-dvw h-dvh bg-white flex flex-col items-center overflow-hidden pt-4 pb-8">
      <div className="w-full text-center z-10 pointer-events-none shrink-0 mb-20">
        <div className="flex flex-wrap items-center justify-center gap-4 text-5xl md:text-6xl font-bold font-mono tracking-tight text-zinc-900">
          <span>Trusted by</span>
          <TextMorph
            words={["Brands..", "Clients..", "Partners.."]}
            interval={2500}

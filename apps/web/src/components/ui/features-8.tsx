...
export function Features8() {
    return (
        <section className="bg-black text-white py-16 md:py-24 mt-12 md:mt-16 overflow-hidden">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="mb-12 md:mb-16 text-center">
                    <h2 className="font-serif font-medium text-3xl md:text-4xl tracking-tight mb-4">Core Capabilities</h2>
                    <p className="font-sans text-gray-400 text-sm md:text-base max-w-2xl mx-auto font-light">
                        Everything you need to run smoothly, beautifully designed and seamlessly integrated into one platform.
                    </p>
                </div>
                
                <div className="relative">
                    {/* Using a 2x2 grid on large screens by making all items lg:col-span-3 inside a 6-col grid */}
                    <div className="relative z-10 grid grid-cols-6 gap-4">
                        {/* 1. Live Dashboard */}
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-3 bg-[#0a0a0a] border-white/10 text-white">
                            <CardContent className="relative m-auto size-fit pt-6 pb-6 flex flex-col items-center">
                                <div className="relative flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold">0s</span>
                                </div>
                                <h2 className="mt-6 text-center text-2xl font-serif font-medium">Live Dashboard</h2>
                                <p className="text-center text-sm text-gray-400 mt-2">Every order lands on your screen the second it's placed.</p>
                            </CardContent>
                        </Card>
                        
                        {/* 2. QR Ordering */}
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-3 bg-[#0a0a0a] border-white/10 text-white group">
                            <CardContent className="pt-6 pb-6">
                                <div className="relative mx-auto flex aspect-square size-32 items-center justify-center rounded-full border dark:border-white/10 before:absolute before:-inset-2 before:rounded-full before:border dark:before:border-white/5 border-white/10 before:border-white/5 overflow-hidden">
                                    {/* Scanning Line Animation */}
                                    <motion.div 
                                        className="absolute left-0 right-0 h-1/2 bg-gradient-to-b from-transparent to-white/20 z-10 border-b-[3px] border-white/80 shadow-[0_0_15px_3px_rgba(255,255,255,0.4)]"
                                        animate={{ top: ["-50%", "100%", "-50%"] }}
                                        transition={{ duration: 3.5, repeat: Infinity, ease: "linear" }}
                                    />
                                    {/* Real QR Code Icon */}
                                    <QrCode className="size-16 text-gray-500 relative z-0" strokeWidth={1.5} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-2xl font-serif font-medium text-white transition">QR Ordering</h2>
                                    <p className="text-gray-400 text-sm">Scan the table, see the menu — no app, no wait, no download.</p>
                                </div>
                            </CardContent>
                        </Card>
                        
                        {/* 3. Flexible Payments */}
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-[#0a0a0a] border-white/10 text-white">
                            <CardContent className="pt-6 pb-6 h-full flex flex-col justify-between">
                                <div className="pt-6 lg:px-6">
                                    <svg className="text-white/20 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" fill="transparent" stroke="currentColor" strokeWidth="2" />
                                        ...
                                        <path
                                            ...
                                            fill="url(#paint0_linear_0_106_flex)"
                                        />
                                        <motion.path
                                            className="text-white"
                                        ...
                                        />
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106_flex" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-white/30" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-2xl font-serif font-medium text-white transition">Flexible Payments</h2>
                                    <p className="text-gray-400 text-sm">UPI, card, or cash at the counter — their choice, every time.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        {/* 4. Loyalty Wallet */}
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-[#0a0a0a] border-white/10 text-white">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2 gap-8 items-center">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <motion.div 
                                        className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5"
                                        animate={{ scale: [1, 1.1, 1] }}
                                        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                                    >
                                        <Users className="m-auto size-6 text-white" strokeWidth={1.5} />
                                    </motion.div>
                                    <div className="space-y-2">
                                        <h2 className="text-2xl font-serif font-medium text-white transition">Loyalty Wallet</h2>
                                        <p className="text-gray-400 text-sm">Regulars get remembered automatically — no math to do, no punch cards to lose.</p>
                                    </div>
                                </div>
                                <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        ...
                                        >
                                            <span className="block h-fit rounded border border-white/20 px-2 py-1 text-xs shadow-sm bg-black">Frequent</span>
                                            <div className="ring-black size-7 ring-4">
                                                <img className="size-full rounded-full object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop" alt="" />
                                            </div>
                                        </motion.div>
                                        <motion.div 
                                        ...
                                        >
                                            <div className="ring-black size-8 ring-4">
                                                <img className="size-full rounded-full object-cover" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border border-white/20 px-2 py-1 text-xs shadow-sm bg-black">VIP</span>
                                        </motion.div>
                                        <motion.div 
                                            className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2"
                                            animate={{ y: [-4, 4, -4] }}
                                        ...
                                        >
                                            <span className="block h-fit rounded border border-white/20 px-2 py-1 text-xs shadow-sm bg-black">Regular</span>
                                            <div className="ring-black size-7 ring-4">
                                                <img className="size-full rounded-full object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="" />
                                            </div>
                                        </motion.div>
                                    </div>
                                </div>
